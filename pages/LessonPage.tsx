...
const LessonPage: React.FC = () => {
  ...
  const renderLessonContent = () => {
    ...
    switch (currentLesson.type) {
      case 'video':
        const videoSrc = getYouTubeEmbedUrl(currentLesson.videoUrl || '');
        return (
      ...
      case 'text':
        return (
          <div className="bg-gray-800 rounded-lg p-6 my-4 prose prose-invert prose-lg max-w-none">
            <p className="text-gray-300 whitespace-pre-wrap">{currentLesson.content}</p>
          </div>
        );
      case 'link':
        return (
            <div className="bg-gray-800 rounded-lg p-8 my-4 text-center">
      ...
      default:
        return <p>Tipo de aula desconhecido.</p>;
    }
  };
